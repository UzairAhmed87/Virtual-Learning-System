...
static constexpr auto qt_meta_stringdata_ZN15TeacherHomePageE = QtMocHelpers::stringData(
    "TeacherHomePage",
    "logoutRequested",
    "",
    "handleButtonClick",
...
Q_CONSTINIT static const uint qt_meta_data_ZN15TeacherHomePageE[] = {
...
Q_CONSTINIT const QMetaObject TeacherHomePage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15TeacherHomePageE.offsetsAndSizes,
    qt_meta_data_ZN15TeacherHomePageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15TeacherHomePageE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TeacherHomePage, std::true_type>,
...
void TeacherHomePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->openProfilePage(); break;
        case 4: _t->gotoHomePage(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (TeacherHomePage::*)();
            if (_q_method_type _q_method = &TeacherHomePage::logoutRequested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *TeacherHomePage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15TeacherHomePageE.stringdata0))
...
// SIGNAL 0
void TeacherHomePage::logoutRequested()
{
