...
static constexpr auto qt_meta_stringdata_ZN12CourseWidgetE = QtMocHelpers::stringData(
    "CourseWidget",
    "backButtonClicked",
    "",
    "searchCourse",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12CourseWidgetE[] = {
...
Q_CONSTINIT const QMetaObject CourseWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12CourseWidgetE.offsetsAndSizes,
    qt_meta_data_ZN12CourseWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12CourseWidgetE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<CourseWidget, std::true_type>,
...
void CourseWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (CourseWidget::*)();
            if (_q_method_type _q_method = &CourseWidget::backButtonClicked; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *CourseWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12CourseWidgetE.stringdata0))
