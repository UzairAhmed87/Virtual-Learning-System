...
static constexpr auto qt_meta_stringdata_ZN16RegisterUserFormE = QtMocHelpers::stringData(
    "RegisterUserForm",
    "backButtonClicked",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN16RegisterUserFormE[] = {
...
Q_CONSTINIT const QMetaObject RegisterUserForm::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16RegisterUserFormE.offsetsAndSizes,
    qt_meta_data_ZN16RegisterUserFormE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16RegisterUserFormE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<RegisterUserForm, std::true_type>,
...
void RegisterUserForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (RegisterUserForm::*)();
            if (_q_method_type _q_method = &RegisterUserForm::backButtonClicked; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *RegisterUserForm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16RegisterUserFormE.stringdata0))
