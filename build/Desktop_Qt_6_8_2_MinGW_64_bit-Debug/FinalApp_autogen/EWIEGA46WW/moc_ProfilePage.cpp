...
static constexpr auto qt_meta_stringdata_ZN11ProfilePageE = QtMocHelpers::stringData(
    "ProfilePage",
    "homeButtonClicked",
    "",
    "uploadPicture"
...
Q_CONSTINIT static const uint qt_meta_data_ZN11ProfilePageE[] = {
...
Q_CONSTINIT const QMetaObject ProfilePage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11ProfilePageE.offsetsAndSizes,
    qt_meta_data_ZN11ProfilePageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11ProfilePageE_t,
        // Q_OBJECT / Q_GADGET
...
void ProfilePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ProfilePage::*)();
            if (_q_method_type _q_method = &ProfilePage::homeButtonClicked; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *ProfilePage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11ProfilePageE.stringdata0))
